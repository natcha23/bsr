...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === _NO_DATA_ )
		{
	...
	function _fnInfoMacros ( settings, str )
	{
		...
		return str.
			replace(/_SHOWING_/g, _SHOWING_).
			replace(/_TO_/g, _TO_).
			replace(/_OF_/g, _OF_).
			replace(/_ENTREIS_/g, _ENTRIES_).
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "_SHOWING_ _START_ _TO_ _END_ _OF_ _TOTAL_ _ENTREIS_",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "_SHOWING_ 0 _TO_ 0 _OF_ 0 _ENTREIS_",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtered from _MAX_ total _ENTREIS_)",
			 ...
			 *    } );
			 */
			"sLengthMenu": "Show _MENU_ _ENTREIS_",
